...
class Planet
{
    constructor(nkEngine, workers, center = null, radius = 1)
    {
       ...
       // var elevationLayer = new BingElevationLayer ("AteBKVs9dTvvEMIEus-KRwyTybV76si7jcncQK5TG02wgMLRG82Fb6ZO2qSVNNvW") ;
        ...
        this._tiles.push(new PlanetTile (nkEngine, workers, unitBounds0, bounds0, null, wmsLayer, center, radius, 0, null, new nkEngine.nkMaths.Vector(0, 0), new nkEngine.nkMaths.Vector(1, 1)));
        this._tiles.push(new PlanetTile (nkEngine, workers, unitBounds1, bounds1, null, wmsLayer, center, radius, 0, null, new nkEngine.nkMaths.Vector(0, 0), new nkEngine.nkMaths.Vector(1, 1)));
